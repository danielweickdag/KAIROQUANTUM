...
// Configure axios defaults - prefer explicit API URL if provided
// Use Next.js rewrite proxy for API calls to avoid CORS in dev
axios.defaults.baseURL = '/api';

// Add request interceptor to include auth token
axios.interceptors.request.use(
  (config) => {
    // Avoid sending Authorization on auth routes (login/register/refresh)
