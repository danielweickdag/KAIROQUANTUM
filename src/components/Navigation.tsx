...
const allNavigationItems: NavigationItem[] = [
  ...
  },
  {
    ...
    href: '/contact',
    icon: Mail,
    description: 'Contact support and send inquiries'
  },
  {
    name: 'FAQ',
    href: '/help/faq',
    icon: HelpCircle,
    description: 'Frequently asked questions and fee schedules'
  },
  {
...
export default function Navigation() {
  ...
  // Check if user is admin (in production, this should be a proper role field)
  const isAdmin = user?.email === 'admin@kairo.com' || user?.username === 'admin';
